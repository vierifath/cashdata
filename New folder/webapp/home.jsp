    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <h1>My Cash Data</h1>
                <p>
My Cash Data guarantees the security and serves your cash payments Today!

You can register for a new account, by entering your email and password, after having an account you can login back in using your account. Trust us, and enjoy our services.</p>
