<%@page import="JSP.dao.cashdataDao,JSP.bean.*,java.util.*"%>  
...
<body>
	<%  
	List<cashdata> list=cashdataDao.getAllRecords();  
...
<!--                        <form action="update-process.jsp">-->
			<table border="1" width="90%">  
                            ...
                            <tr><th>Id</th><th>Name</th><th>Email</th><th>Week1</th><th>Week2</th><th>Week3</th><th>Week4</th><th>Week5</th><th>Week6</th><th>Week7</th><th>Week8</th><th>Week9</th><th>Week10</th>    
                            <th>Edit</th><th>Delete</th></tr>  
                            <c:forEach items="${list}" var="u">  
                            <tr><td>${u.getId()}</td><td>${u.getName()}</td><td>${u.getEmail()}</td><td>${u.getWeek1()}</td><td>${u.getWeek2()}</td><td>${u.getWeek3()}</td><td>${u.getWeek4()}</td><td>${u.getWeek5()}</td><td>${u.getWeek6()}</td><td>${u.getWeek7()}</td><td>${u.getWeek8()}</td><td>${u.getWeek9()}</td><td>${u.getWeek10()}</td>  
                            <td><a href="editform.jsp?id=${u.getId()}" class="btn btn-warning">Edit</a></td>  
                            <td><a href="cd_delete.jsp?id=${u.getId()}" class="btn btn-danger">Delete</a></td></tr>  
                            </c:forEach>  
                        </table>  
